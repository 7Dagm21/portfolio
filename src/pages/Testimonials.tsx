                        ...
                        >
                            <div className="flex">
                                {testimonials.map((testimonial, index) => (
                                    <div
                                        key={testimonial.id || index} // Fallback to index if id is not available
                                    ...
                                    >
                                        <div className="max-w-4xl mx-auto">
                                            <div className="flex flex-col md:flex-row gap-6 items-stretch">
                                                ...
                                                {/* Content / Quote section (placed to the right on md+) */}
                                                <div className="w-full md:w-2/3 flex-1 flex flex-col justify-center py-4">
                                                    <div className="mb-6">
