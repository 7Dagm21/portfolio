	...
	return (
		<div className="group relative bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-primary/30 transition-all duration-300">
				...
				<div className="absolute bottom-4 right-4 flex items-center gap-3">
					...
					{githubUrl && (
						<a
							...
							target="_blank"
							rel="noopener noreferrer"
							className="p-2.5 bg-white/1- backdrop-blur-md rounded-lg border border-white/20 hover:bg-primary/30 hover:border-primary/50 transition-all duration-300 hover:scale-110"
							title="View Code"
						>
            ...
            <div className="p-6 space-y-4">
                <div>
                    <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-[#A8FF80] transition-colors duration-300">
                        {title}
                    </h3>
